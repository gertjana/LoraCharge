...
{var pred__11533 = cljs.core._EQ_;var expr__11534 = limit;if(cljs.core.truth_(pred__11533.call(null,(1),expr__11534)))
...
{var temp__4423__auto__ = cljs.core.re_find.call(null,re,s__$1);if(cljs.core.truth_(temp__4423__auto__))
{var m = temp__4423__auto__;var index = s__$1.indexOf(m);{
var G__11536 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__11537 = (limit__$1 - (1));
var G__11538 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__11536;
limit__$1 = G__11537;
parts = G__11538;
continue;
...
{var ch = s.charAt(index);var temp__4423__auto___11540 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4423__auto___11540))
{var replacement_11541 = temp__4423__auto___11540;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_11541)));
} else
{buffer.append(ch);
}
{
var G__11542 = (index + (1));
index = G__11542;
continue;
}
}
