...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_15021 = (0);while(true){
var m_15022 = cljs.core.async.impl.dispatch.tasks.pop();if((m_15022 == null))
{} else
{m_15022.call(null);
if((count_15021 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__15023 = (count_15021 + (1));
count_15021 = G__15023;
continue;
}
} else
{}
