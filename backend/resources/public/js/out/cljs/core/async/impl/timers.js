...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_14941 = (0);while(true){
...
var temp__4423__auto__ = (x__$1.forward[level]);if(cljs.core.truth_(temp__4423__auto__))
{var x_SINGLEQUOTE_ = temp__4423__auto__;if((x_SINGLEQUOTE_.key < k))
{{
...
{var i_14948 = (self__.level + (1));while(true){
if((i_14948 <= (new_level + (1))))
{(update[i_14948] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_14950 = (0);while(true){
if((i_14950 <= self__.level))
{var links_14951 = (update[i_14950]).forward;if(((links_14951[i_14950]) === x__$1))
{(links_14951[i_14950] = (x__$1.forward[i_14950]));
{
